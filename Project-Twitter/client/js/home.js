  ...
  if (!user.error) {
    ...
    <div class="d-flex">
      <div class="col-4 text-center">
        <a href="#" class="h4 font-bolder mb-0" id="numOfPosts">${
      ...
      <div class="col-4 text-center">
        <a href="#" class="h4 font-bolder mb-0">${user.following.length + 3}</a>
...
//   const post = document.getElementById("tweetPost").value;
